...
import id.co.bankmandiri.common.CameraCapturerCompat
import id.co.bankmandiri.viewmodel.VideoCallViewModel
...
import id.co.bankmandiri.common.api.getData
...
class VideoActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        vm.videoCallLinkResponseObservable.observe(
            this,
            Observer {
                it?.apply {
        ...
        loadEmailAddress().apply {
            if (isNotEmpty()) {
                vm.videoCallLink(this)
            }
        }
    ...
    private fun retrieveAccessTokenfromServer() {
        "$ACCESS_TOKEN_SERVER?identity=${UUID.randomUUID()}".getData(object : Callback,
            okhttp3.Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                this@VideoActivity.accessToken = response.body?.string() ?: ""
            }
        })
    }
